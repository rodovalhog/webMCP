...
export const FALLBACK_SEMANTIC_RESOURCES: SemanticResourceMap = {
  ...
  // NÍVEL 1: Menu Principal Secretaria
  secretaria: {
    id: "secretaria",
    resource: "secretaria",
    action: "navigate",
    description: "Central da Secretaria Acadêmica: matrículas, rematrículas e gestão de disciplinas curriculares",
    target: "/dashboard/secretaria",
    access: "student",
    parent: "dashboard",
    breadcrumbs: ["Dashboard", "Secretaria"],
  },
  ...
  // NÍVEL 2: Subpáginas diretas de Secretaria
  secretaria_matricula: {
    id: "secretaria_matricula",
    resource: "secretaria_matricula",
    action: "navigate",
    description: "Subpágina de Matrícula de Alunos: formulário de ingresso, validação de dados e documentação",
    target: "/dashboard/secretaria/matricula",
    access: "student",
    parent: "secretaria",
    breadcrumbs: ["Dashboard", "Secretaria", "Matrícula"],
  },
  secretaria_rematricula: {
    id: "secretaria_rematricula",
    resource: "secretaria_rematricula",
    action: "navigate",
    description: "Subpágina de Rematrícula: renovação de matrícula para o próximo período e checagem de pendências",
    target: "/dashboard/secretaria/rematricula",
    access: "student",
    parent: "secretaria",
    breadcrumbs: ["Dashboard", "Secretaria", "Rematrícula"],
  },
  secretaria_disciplinas: {
    id: "secretaria_disciplinas",
    resource: "secretaria_disciplinas",
    action: "navigate",
    description: "Subpágina intermediária de Disciplinas da Secretaria: catálogo da matriz curricular",
    target: "/dashboard/secretaria/disciplinas",
    access: "student",
    parent: "secretaria",
    breadcrumbs: ["Dashboard", "Secretaria", "Disciplinas"],
  },
  // NÍVEL 3: Disciplinas específicas
  secretaria_disciplina_matematica: {
    id: "secretaria_disciplina_matematica",
    resource: "secretaria_disciplina_matematica",
    action: "view",
    description: "Disciplina de Matemática: ementa de álgebra linear, cálculo diferencial, notas e horários",
    target: "/dashboard/secretaria/disciplinas/matematica",
    access: "student",
    parent: "secretaria_disciplinas",
    breadcrumbs: ["Dashboard", "Secretaria", "Disciplinas", "Matemática"],
  },
  secretaria_disciplina_portugues: {
    id: "secretaria_disciplina_portugues",
    resource: "secretaria_disciplina_portugues",
    action: "view",
    description: "Disciplina de Português: ementa de comunicação e redação técnica, literatura e gramática",
    target: "/dashboard/secretaria/disciplinas/portugues",
    access: "student",
    parent: "secretaria_disciplinas",
    breadcrumbs: ["Dashboard", "Secretaria", "Disciplinas", "Português"],
  },
  secretaria_disciplina_ciencias: {
    id: "secretaria_disciplina_ciencias",
    resource: "secretaria_disciplina_ciencias",
    action: "view",
    description: "Disciplina de Ciências: laboratórios práticos, metodologia científica e biologia",
    target: "/dashboard/secretaria/disciplinas/ciencias",
    access: "student",
    parent: "secretaria_disciplinas",
    breadcrumbs: ["Dashboard", "Secretaria", "Disciplinas", "Ciências"],
  },
  secretaria_disciplina_historia: {
    id: "secretaria_disciplina_historia",
    resource: "secretaria_disciplina_historia",
    action: "view",
    description: "Disciplina de História: história moderna, contemporânea e patrimônio cultural",
    target: "/dashboard/secretaria/disciplinas/historia",
    access: "student",
    parent: "secretaria_disciplinas",
    breadcrumbs: ["Dashboard", "Secretaria", "Disciplinas", "História"],
  },
};
